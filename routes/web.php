...
Route::get('/carte-cadeau', [DashboardController::class, 'cartecadeau'])->middleware(['auth', 'verified'])->name('amazon');
Route::get('/bon-de-voyage', [DashboardController::class, 'bonvoyage'])->middleware(['auth', 'verified'])->name('apple');
